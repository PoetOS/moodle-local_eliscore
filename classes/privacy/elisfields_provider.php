...
/**
 * ELISfields subplugin privacy interface. A subplugin should implement this if it stores user data.
 *
 * @package    elisfields
...
namespace local_elisfields\privacy;

defined('MOODLE_INTERNAL') || die();

interface elisfields_provider extends
